...
import { idlFactory } from './hello_world_canister.did.js';
export { idlFactory } from './hello_world_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.HELLO_WORLD_CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hello_world_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hello_world_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hello_world_canister.did.js")._SERVICE>}
 */
export const hello_world_canister = createActor(canisterId);
